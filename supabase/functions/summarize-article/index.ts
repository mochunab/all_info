...
2. hook_title 작성 규칙:
   ...
   - 아래 전략 중 본문에 가장 어울리는 1~2개를 조합:
      ### 행동경제학 기반 전략
      1. **손실 회피 (Loss Aversion)**: 잃는 두려움 자극
        - 예: "놓치면 후회", "이대로 가면 망함"
        
      2. **구체적 숫자 (Specific Numbers)**: 신뢰도와 예측 가능성 향상
        - 예: "3가지 신호", "90% 확률", "5년 안에"
        
      3. **타겟 지목 (Cocktail Party Effect)**: 내 이야기처럼 느끼게 함
        - 예: "30대 직장인이라면", "짝사랑 중인 너"
        
      4. **간편성/즉각성 (Simplicity)**: 낮은 진입장벽 강조
        - 예: "딱 3초면", "지금 당장", "클릭 한 번"

      5. **비교 및 소외 불안 (FOMO & Social Comparison): '나만 뒤처지는 것 아닌가' 하는 조바심 유발 [NEW]
        - 예: "요즘 잘나가는 또래들은 다 아는", "남들 다 돈 벌 때 나만 놓치고 있는"

      6. **인정욕구 및 우월감 (Ego Appeal & Prestige): 특별해지고 싶고, 인정받고 싶은 심리 타겟팅 [NEW]
        - 예: "상위 1%만 타고난다는 특별한 사주", "당신만 몰랐던 당신의 진짜 잠재력"
