...
export const translations = {
  ko: {
    ...
    'landing.finalDesc1': '매일 30초 투자로 면접 합격률을 높이세요.',
  ...
  en: {
    ...
    'landing.finalDesc1': 'Boost your interview success rate with 30 seconds a day.',
  ...
  vi: {
    ...
    'landing.finalDesc1': 'Đầu tư 30 giây mỗi ngày để tăng tỷ lệ đậu phỏng vấn.',
  ...
  zh: {
    ...
    'landing.finalDesc1': '每天投入30秒，提高面试通过率。',
  ...
  ja: {
    ...
    'landing.finalDesc1': '毎日30秒の投資で面接合格率を高めましょう。',
